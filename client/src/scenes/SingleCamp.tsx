...
const SingleCamp = () => {
  ...
  const { title, description, image, price, location, review }: ICampAndReview =
    campground;
  ...
  return (
    <div className="mx-auto max-w-7xl px-2 py-6 lg:px-0">
      <div className="overflow-hidden mb-9 pt-4 md:px-6 md:pt-7 lg:mb-2">
